...
-- 9. TABLA DE PREDICCIONES (Resultados de GlucoGen)
...
COMMENT ON TABLE predictions IS 'Almacena los resultados del motor de IA GlucoGen V2, incluyendo bandas de confianza y narrativa clínica.';
